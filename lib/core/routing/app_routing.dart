...
import 'package:hasna/features/favourites/presentation/screens/favourite_view.dart';
...
class AppRouting {
  static final GoRouter router = GoRouter(
    ...
    routes: <GoRoute>[
      GoRoute(path: Routes.tasbiha, builder: (context, state) => TasbihaView()),
      GoRoute(
      ...
      GoRoute(
        ...
        builder:
            (context, state) =>
                PubliczakerDeatilsView(model: state.extra as TasabihModel),
      ),
      ...
      GoRoute(
        ...
        builder:
            (context, state) =>
                AzkerView(data: state.extra as Map<String, String>),
      ),
